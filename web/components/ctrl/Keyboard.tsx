...
function KeyDiagram() {
  ...
  const pointers = [
    ...
    //   d: "M 400 55 L 400 110 L 400 150",
    // },
    {
      id: "left",
      label: "LEFT · STRAFE",
      ...
      d: "M 160 250 L 240 250 L 300 250",
    },
    // {
    //   id: "down",
    //   label: "DOWN · DUCK",
    ...
    //   ly: 400,
    //   anchor: "middle" as const,
    //   d: "M 400 385 L 400 310 L 400 280",
    // },
    {
      id: "right",
      label: "RIGHT · STRAFE",
      ...
      ly: 255,
      anchor: "end" as const,
      d: "M 640 250 L 560 250 L 500 250",
    },
    {
      id: "r",
      label: "R · RESTART",
    ...
    },
    {
      ...
      ly: 100,
      anchor: "end" as const,
      d: "M 740 115 L 740 180 L 620 180",
    },
  ];
...
function KeyCap({
  ...
  return (
    <g>
      {/* shadow */}
      <rect x={x + 3} y={y + 4} width={w} height={h} fill="var(--color-muted)" />
      {/* cap */}
      <rect
        x={x}
        y={y}

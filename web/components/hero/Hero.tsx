  ...
  return (
    <section className='relative w-full border border-border'>
      <div className='flex flex-col md:flex-row '>
        <div className='flex flex-col gap-8 px-6 md:px-8 p-16 md:py-24 border-r w-auto md:w-[75%]'>
          <motion.div
          ...
          <div className="w-full flex justify-center mt-">
            <button
              type='button'
              onClick={copy}
              className='group flex w-full max-w-2xl items-center justify-between gap-4 border border-border bg-card/60 px-4 py-3 text-left transition-colors hover:border-secondary'
        ...
        <div className='px-6 md:px-8 py-12 w-auto md:w-[25%]'>
          <HighScores />
        </div>
      </div>
    </section>
